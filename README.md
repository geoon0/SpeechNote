...
| 이름 | 학번 | 역할 |
| --- | --- | --- |
| 정의영 (팀장) | 20220505 | **UI·DB·결과·관리** — 로그인, SQLite 연동, 히스토리/검색/정렬, 내보내기, 원문 편집, 미니 플레이어, 에러 로깅, Two-Split UI |
| 민건영 | 20210598 | **입력·오디오·API** — 실시간 녹음·장치 선택, 파일 업로드, 커스텀 STT API 통신, 설정 관리, 비동기·진행 표시, 요약·키워드 |
