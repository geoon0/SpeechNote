...
| F-06 | 회원가입·로그인 | 민건영 | 높음 |
| F-07 | 로컬 SQLite DB 연동 | 민건영 | 높음 |
| F-08 | 좌측 히스토리 패널 | 민건영 | 중간 |
| F-09 | 우클릭 컨텍스트 메뉴 | 민건영 | 중간 |
| F-10 | TXT 내보내기 | 민건영 | 중간 |
| F-11 | DOCX·SRT 내보내기 | 민건영 | 중간 |
| F-12 | STT 원문 편집 | 민건영 | 중간 |
| F-13 | 핵심 요약 | 민건영 | 중간 |
| F-14 | 주요 키워드 추출 | 민건영 | 중간 |
| F-15 | 실시간 통합 검색 | 민건영 | 중간 |
| F-16 | 목록 정렬 | 민건영 | 낮음 |
| F-17 | 보안·계정 관리(비밀번호 변경·탈퇴) | 민건영 | 낮음 |
| F-18 | 오디오 재생 미니 플레이어 | 민건영 | 낮음 |
| F-19 | 전역 에러 로깅 | 민건영 | 높음 |
| F-20 | Two-Split 레이아웃 UI | 민건영 | 높음 |
